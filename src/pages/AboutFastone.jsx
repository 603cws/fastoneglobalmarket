        ...
        <div className="container">
          <div className="flex justify-center items-center">
            ...
            <div className="flex-1 about-text">
              <h3 className=" text-2xl capitalize font-bold bg-gradient-to-r from-[#4575FF] to-[#92AEFF] text-transparent bg-clip-text">
                FastOne Global Financial Markets Limited
              </h3>
              <p className="text-wrap text-[#B2B2B2]">
            ...
            <div className="flex-1 ">
              <div className="w-2/3">
                ...
                <p className="text-[#B2B2B2] text-sm text-wrap">
                  FastOne aims growth by provision of highest possible level of
                  Customer Service to Clientele by focusing resources on
            ...
            <div className="flex-1">
              <div className="w-2/3">
                ...
                <p className="text-[#B2B2B2] text-sm text-wrap">
                  ...
                  and authentic trading experience to our Clients as we continue
                  to drive and embrace change in a dynamic environment.
                  Prominent values at FastOne include Innovation, Integrity,
                  Team work, Respect for people and new ideas.
                </p>
              </div>
            </div>
            <div className="flex-1 flex justify-end">
