        ...
        <div className="container">
          <div className="row">
            <div className="col-12 about-text">
              ...
              <h3 className="mt-4">Purpose of the Data processing</h3>
              <p>
              ...
              <h3 className="mt-4">Principles of the Data processing</h3>
              <p>All data is :</p>
              <ul>
              ...
              <h3 className="mt-4">Personal Data We Collect</h3>
              ...
              <h3 className="mt-4">Use of Cookies</h3>
              <p>
              ...
              <h3 className="mt-4">Reasons We Share Personal Data</h3>
              <p>
              ...
              <h3 className="mt-4">Our Affiliates and Partners</h3>
              <p>
              ...
              <h3 className="mt-4">Non-affiliated third parties.</h3>
              <p>
              ...
              <h3 className="mt-4">Access to Personal Data</h3>
              <p>
              ...
              <h3 className="mt-4">Security of Personal Data</h3>
              <p>
              ...
              <h3 className="mt-4">Breach of Personal Data</h3>
              <p>
              ...
              <h3 className="mt-4">Retention of Personal Data</h3>
              <p>
