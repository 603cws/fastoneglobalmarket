...
const advantages = [
  ...
  },
  {
    ...
    description: 'FastOne is a Mauritius based broker authorised and regulated by the Financial Services Commission (the “FSC”). We are a leading financial intermediary with a significant presence in Europe, MENA and South East Asia regions offering online trading solutions. Our senior management has extensive industry experience spanning over 25 years on aggregate, and this translates into our transparent, reliable, and reputable service.',
  },
  {
