...
const Cta2Btn = ({ title, description, button1, button2, buttonLinks }) => {
  ...
  return (
    <div className="!bg-[#1368A6]/20 flex justify-center text-center my-8 md:my-20  py-8 border border-[#4575FF] rounded-2xl">
      <div className="">
        <h2 className="text-xl md:text-2xl lg:text-3xl text-white leading-tight ">
          {title}
        </h2>
        <p>{description}</p>
        <div>
          <a
            ...
            className="inline-block text-center font-medium  md:text-lg px-4 py-2 md:px-5  md:py-4 rounded-xl text-black hover:opacity-90 bg-white m-4"
